...
func (p *FmcProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewDeviceOSPFResource,
		NewDeviceOSPFInterfaceResource,
		NewDevicePhysicalInterfaceResource,
		NewDeviceSubinterfaceResource,
		NewDeviceVirtualTunnelInterfaceResource,
		NewDeviceVNIInterfaceResource,
		NewDeviceVRFResource,
		NewDeviceVTEPPolicyResource,
		NewDistinguishedNameResource,
		NewDistinguishedNamesResource,
		NewDNSServerGroupResource,
		NewDNSServerGroupsResource,
		NewDynamicAccessPolicyResource,
		NewDynamicObjectsResource,
		NewExpandedCommunityListResource,
		NewExpandedCommunityListsResource,
		NewExtendedAccessListResource,
		NewExtendedCommunityListResource,
		NewExtendedCommunityListsResource,
		NewExternalCertificateResource,
		NewFilePolicyResource,
		NewFQDNResource,
		NewFQDNOverridesResource,
		NewFQDNsResource,
		NewFTDAutoNATRuleResource,
		NewFTDManualNATRuleResource,
		NewFTDNATPolicyResource,
		NewFTDPlatformSettingsResource,
		NewFTDPlatformSettingsBannerResource,
		NewFTDPlatformSettingsDNSResource,
		NewFTDPlatformSettingsHTTPAccessResource,
		NewFTDPlatformSettingsICMPAccessResource,
		NewFTDPlatformSettingsSNMPResource,
		NewFTDPlatformSettingsSSHAccessResource,
		NewFTDPlatformSettingsSyslogEmailSetupResource,
		NewFTDPlatformSettingsSyslogEventListResource,
		NewFTDPlatformSettingsSyslogLoggingDestinationResource,
		NewFTDPlatformSettingsSyslogLoggingSetupResource,
		NewFTDPlatformSettingsSyslogRateLimitResource,
		NewFTDPlatformSettingsSyslogServersResource,
		NewFTDPlatformSettingsSyslogSettingsResource,
		NewFTDPlatformSettingsSyslogSettingsSyslogIDResource,
		NewFTDPlatformSettingsTimeSynchronizationResource,
		NewFTDPlatformSettingsTrustedDNSServersResource,
		NewGeolocationResource,
		NewGeolocationsResource,
		NewGroupPolicyResource,
		NewHealthPolicyResource,
		NewHostResource,
		NewHostOverridesResource,
		NewHostsResource,
		NewICMPv4Resource,
		NewICMPv4sResource,
		NewICMPv6Resource,
		NewICMPv6sResource,
		NewIdentityPolicyResource,
		NewIKEv1IPsecProposalResource,
		NewIKEv1IPsecProposalsResource,
		NewIKEv1PoliciesResource,
		NewIKEv1PolicyResource,
		NewIKEv2IPsecProposalResource,
		NewIKEv2IPsecProposalsResource,
		NewIKEv2PoliciesResource,
		NewIKEv2PolicyResource,
		NewInterfaceGroupResource,
		NewInterfaceGroupsResource,
		NewInternalCertificateResource,
		NewInternalCertificateAuthorityResource,
		NewIntrusionPolicyResource,
		NewIntrusionPolicyGroupOverrideResource,
		NewIntrusionPolicyRuleOverrideResource,
		NewIntrusionRuleResource,
		NewIntrusionRuleGroupResource,
		...
		NewKeyChainResource,
		NewKeyChainsResource,
		NewMACAddressPoolResource,
		NewMACAddressPoolsResource,
		NewNetworkResource,
		...
		NewRangeResource,
		NewRangeOverridesResource,
		NewRangesResource,
		NewRealmADLDAPResource,
		NewRealmLocalResource,
		NewResourceProfileResource,
...
func (p *FmcProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewCipherSuiteListDataSource,
		NewCipherSuiteListsDataSource,
		...
		NewDeviceCertificateDataSource,
		NewDeviceClusterDataSource,
		NewDeviceClusterHealthMonitorDataSource,
		NewDeviceDDNSDataSource,
		NewDeviceDHCPRelayDataSource,
		NewDeviceDHCPServerDataSource,
		NewDeviceECMPZoneDataSource,
		...
		NewDeviceOSPFDataSource,
		NewDeviceOSPFInterfaceDataSource,
		NewDevicePhysicalInterfaceDataSource,
		NewDeviceSubinterfaceDataSource,
		NewDeviceVirtualTunnelInterfaceDataSource,
		NewDeviceVNIInterfaceDataSource,
		NewDeviceVRFDataSource,
		NewDeviceVTEPPolicyDataSource,
		NewDistinguishedNameDataSource,
		NewDistinguishedNamesDataSource,
		NewDNSServerGroupDataSource,
		NewDNSServerGroupsDataSource,
		...
		NewExtendedAccessListDataSource,
		...
		NewFQDNDataSource,
		NewFQDNOverridesDataSource,
		NewFQDNsDataSource,
		NewFTDAutoNATRuleDataSource,
		NewFTDManualNATRuleDataSource,
		NewFTDNATPolicyDataSource,
		NewFTDPlatformSettingsDataSource,
		NewFTDPlatformSettingsBannerDataSource,
		NewFTDPlatformSettingsDNSDataSource,
		NewFTDPlatformSettingsHTTPAccessDataSource,
		NewFTDPlatformSettingsICMPAccessDataSource,
		NewFTDPlatformSettingsSNMPDataSource,
		NewFTDPlatformSettingsSSHAccessDataSource,
		NewFTDPlatformSettingsSyslogEmailSetupDataSource,
		NewFTDPlatformSettingsSyslogEventListDataSource,
		NewFTDPlatformSettingsSyslogLoggingDestinationDataSource,
		NewFTDPlatformSettingsSyslogLoggingSetupDataSource,
		NewFTDPlatformSettingsSyslogRateLimitDataSource,
		NewFTDPlatformSettingsSyslogServersDataSource,
		NewFTDPlatformSettingsSyslogSettingsDataSource,
		NewFTDPlatformSettingsSyslogSettingsSyslogIDDataSource,
		NewFTDPlatformSettingsTimeSynchronizationDataSource,
		NewFTDPlatformSettingsTrustedDNSServersDataSource,
		NewGeolocationDataSource,
		NewGeolocationsDataSource,
		NewGroupPolicyDataSource,
		NewHealthPolicyDataSource,
		NewHostDataSource,
		NewHostOverridesDataSource,
		NewHostsDataSource,
		NewICMPv4DataSource,
		NewICMPv4sDataSource,
		NewICMPv6DataSource,
		NewICMPv6sDataSource,
		NewIdentityPolicyDataSource,
		NewIKEv1IPsecProposalDataSource,
		NewIKEv1IPsecProposalsDataSource,
		NewIKEv1PoliciesDataSource,
		NewIKEv1PolicyDataSource,
		NewIKEv2IPsecProposalDataSource,
		NewIKEv2IPsecProposalsDataSource,
		NewIKEv2PoliciesDataSource,
		NewIKEv2PolicyDataSource,
		...
		NewIntrusionPolicyGroupOverrideDataSource,
		NewIntrusionPolicyRuleOverrideDataSource,
		NewIntrusionRuleDataSource,
		NewIntrusionRuleGroupDataSource,
		NewIntrusionRuleGroupsDataSource,
		...
		NewKeyChainsDataSource,
		NewMACAddressPoolDataSource,
		NewMACAddressPoolsDataSource,
		NewNetworkDataSource,
		NewNetworkAnalysisPolicyDataSource,
		NewNetworkGroupDataSource,
		NewNetworkGroupOverridesDataSource,
		NewNetworkGroupsDataSource,
		NewNetworkOverridesDataSource,
		NewNetworksDataSource,
		NewPolicyAssignmentDataSource,
		NewPolicyListDataSource,
		NewPolicyListsDataSource,
		NewPortDataSource,
		...
		NewRangeDataSource,
		NewRangeOverridesDataSource,
		NewRangesDataSource,
		NewRealmADLDAPDataSource,
		NewRealmLocalDataSource,
		NewRealmUserGroupsDataSource,
